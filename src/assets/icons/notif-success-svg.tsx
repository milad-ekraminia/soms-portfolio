  ...
  return (
    ...
    >
      <mask
        ...
        height="40"
      >
        <rect width="40" height="40" fill="url(#paint0_linear_2442_73655)" />
      </mask>
      <g mask="url(#mask0_2442_73655)">
        <circle cx="20" cy="20" r="19.5" fill="#EFFFF4" stroke="#17B26A" />
      </g>
      <rect x="6" y="6" width="28" height="28" rx="14" fill="#079455" />
      <path
