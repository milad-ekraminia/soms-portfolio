  ...
  return (
    ...
    >
      <mask
        ...
        height="40"
      >
        <rect width="40" height="40" fill="url(#paint0_linear_2442_73697)" />
      </mask>
      <g mask="url(#mask0_2442_73697)">
        <circle cx="20" cy="20" r="19.5" fill="#EFF8FF" stroke="#B2DDFF" />
      </g>
      <rect x="6" y="6" width="28" height="28" rx="14" fill="#1570EF" />
      <path
