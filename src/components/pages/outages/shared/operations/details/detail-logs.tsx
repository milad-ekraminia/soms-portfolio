...
import { PlannedLogs } from "./detail-tab/data-logs/planned-logs";
import { UnPlannedLogs } from "./detail-tab/data-logs/unPlanned-logs";
...
export const DetailLogs = ({
  ...
  return drawerType == "plannedOutage" ? (
    <PlannedLogs plannedOutageId={chosenRows} />
  ) : (
    <UnPlannedLogs chosenRows={chosenRows} />
  );
