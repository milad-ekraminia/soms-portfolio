...
import { usePlannedOutageDetailLogs } from "@/hooks/outage/planned-outage/use-get-planned-outage-detail";
...
export const PlannedLogs = ({ plannedOutageId }: { plannedOutageId: number }) => {
  const dispatch = useDispatch();

  const tableName = "plannedOutageDetailLogsColumns";
  ...
  function useFetchOutageDetailCombinedDeductions(
    ...
    return usePlannedOutageDetailLogs({
      page,
      pageSize,
      plannedOutageId: plannedOutageId,
