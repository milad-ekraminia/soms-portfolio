...
import { detailInteruptionTabColumn as detailInteruptionTabColumnConfig } from "@/helpers/data/outage";
...
export const DetailInterruptions = ({
  ...
  const tableName = "unPlannedOutageDetailInterruptionCOlumns";
  ...
  // --- Columns ---
  const detailInteruptionColumn = detailInteruptionTabColumnConfig(
    handleRowClick,
    tempFilters,
    setFilter,
    drawerType
  ...
  return (
    <div className="detail-interruptions">
      <Table
        data={data?.items ?? []}
