...
import { notificationTabColumn as notificationTabColumnConfig } from "@/helpers/data/outage-tree-detail";
...
export const DetailTreeNotifications = ({
  handleRowClick,
  chosenRows,
  NodeElementHandler,
  clickedNode,
  ...
  const tableName = "ogssDetailTreeNotificationTable";
  ...
  const notificationTabColumn = notificationTabColumnConfig(
    handleRowClick,
    t,
    NodeElementHandler,
    highlightedNodes?.markedNotification,
    tempFilters,
    setFilter
  );
  ...
  const { columnOrder, setColumnOrder, effectiveColumns } = useTableColumns({
    tableName,
    allColumns: notificationTabColumn,
  });
